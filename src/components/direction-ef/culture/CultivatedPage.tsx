...
/**
 * Cultivated — sparse manifesto / story-led recipe (about-us-13 DNA).
 * Opener → manifesto → cream pull-quote → principles ruled index.
 * Todd IA leaf — no live twin; draft until client copy.
 */
export default function CultivatedPage({ onBack, onNav }: PageProps) {
  const c = CULTIVATED;
